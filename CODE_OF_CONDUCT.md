# Code of Conduct for RCT-Reviewer

## Our Pledge

In the interest of fostering an open, inclusive, and safe environment, we as contributors and maintainers of **RCT-Reviewer** pledge to respect all people who engage with our project, including users, contributors, and collaborators.
...
Maintainers of RCT-Reviewer will review reports and respond appropriately, which may include:
...
This Code of Conduct applies to all interactions involving **RCT-Reviewer**, including:
...
By participating in RCT-Reviewer - whether using the tool, contributing code, validating data, or providing feedback — you agree to follow this Code of Conduct.
